...
from functions.LOOCVtool import LOOCVtool
from functions.MCCAtool import whiten, center, zscore, PCA_60
from functions.load_fMRI import load_Haxby, reorder, pad_arrays, data_selector

from functions.CV_Tool import CV_Tool
from functions.config import CONFIG

# Settings
data_dir = '/data2/xwu/testing/diff_mask'  # diff_mask, one_mask
...
if os.path.exists(data_path) and os.path.exists(label_path):
    ...
    load_Haxby(data_dir, sub_range=range(1, 7), fetch_data=fetch_data, individual_mask=diff_mask)
    # Load data
...
CONFIG["MCCA"]["n_components_mcca"] = int(300)
CV = CV_Tool(method='MCCA', permute=False, seed=20241201, random_train=False, random_voxel=False, nested=False)
